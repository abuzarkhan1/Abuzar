...
const HeroBanner = () => {
    ...
    return (
            ...
            <Wrapper>
                ...
                >
                    <div className="flex items-center gap-[6px]">
                        ...
                        <div>abuzarkhan1242@gmail.com</div>
                    </div>
                ...
                >
                    <div className="font-light mb-4">
                        👋 Hi, I Am{" "}
                        <span className="font-semibold">Abuzar Khan,</span>
                    </div>
        ...
        <a href="https://www.linkedin.com/in/abuzar-khan-147916247/" style={iconStyle}>
          <i className="fab fa-linkedin"></i>
        </a>
        <a href="https://github.com/abuzarkhan1" style={iconStyle}>
