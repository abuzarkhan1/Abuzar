...
const Portfolio = () => {
    ...
    return (
        <div id="work" className="bg-[#111111] py-[60px] md:py-[100px] relative overflow-hidden border-b border-[#222222]">
            {/* AMBIENT GRADIENTS */}
            ...
            <Wrapper>
                ...
                <Div className="mb-10 text-center">
                    <div className="flex text-center justify-center gap-2 md:gap-0 md:flex-col text-[40px] md:text-[85px] 2xl:text-[110px] leading-[44px] md:leading-[90px] 2xl:leading-[115px] font-oswald uppercase text-gradient mb-3">
                        Featured Projects
                    </div>
                    <div className="text-[15px] md:text-[17px] 2xl:text-[20px] leading-[24px] 2xl:leading-[32px] text-[#CCCCCC] text-center max-w-[800px] mx-auto font-light">
                ...
                <Div className="flex justify-start md:justify-center gap-[10px] mb-[45px] overflow-x-auto pb-2 scrollbar-none">
                    {filters.map((item, index) => (
                        <button
                            key={index}
                            className={`rounded-lg py-[9px] px-[20px] text-[14px] md:text-[15px] 2xl:text-[18px] font-medium transition-all duration-300 whitespace-nowrap cursor-pointer border ${
                                selectedTag === item.id
